...
cfg.train.geometry_mode = 'legacy_crop'
cfg.train.full_object_rate = 0.9
cfg.train.full_object_margin_min = 0.1
cfg.train.full_object_margin_max = 0.25
cfg.train.image_size_min_height = 256
cfg.train.image_size_max_height = 480
cfg.train.image_size_min_width = 256
cfg.train.image_size_max_width = 640
